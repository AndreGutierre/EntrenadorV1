...
const problemasMatematicos = [
    {
      ...
      {
        ecuacion: 'Se quiere pintar la superficie exterior de una casa rectangular con una altura de 5 metros, un ancho de 4 metros y una longitud de 8 metros. ¿Cuántos metros cuadrados de pintura se necesitan?',
      ...
      {
        ecuacion: 'Un tejado a dos aguas tiene una base de 8 metros, una altura de 4 metros y una longitud de 6 metros. ¿Cuál es el área total del tejado?',
        respuestaNumerica: ['Área total = 48 metros cuadrados'],
        unidadRespuesta: ['m^2'],
        pasos: [
          'Calcular el área de una cara del tejado: (base x altura) / 2.',
          'Calcular el área total del tejado: 2 x área de una cara.'
        ]
      },
      {
      ...
      {
        ecuacion: 'Una puerta rectangular tiene una altura de 2 metros y una anchura de 0.8 metros. Se desea pintar la superficie de la puerta. ¿Cuántos metros cuadrados de pintura se necesitan?',
      ...
      {
        ecuacion: 'Un tanque cilíndrico tiene un radio de 0.5 metros y una altura de 1 metro. Se desea llenarlo de agua. ¿Cuántos litros de agua se necesitan?',
        respuestaNumerica: ['Volumen = 785 litros'],
        unidadRespuesta: ['lts'],
        pasos: [
          'Calcular el volumen del tanque: πr^2h.',
          'Convertir el volumen de metros cúbicos a litros multiplicando por 1000.'
        ]
      },
      {
        ecuacion: 'Una chimenea rectangular tiene una altura de 4 metros y una sección transversal de 30 cm de largo y 20 cm de ancho. Se desea pintar la superficie interior de la chimenea. ¿Cuántos metros cuadrados de pintura se necesitan?',
      ...
      {
        ecuacion: 'Un tejado a dos aguas tiene una base de 6 metros, una altura de 3 metros y una longitud de 8 metros. Se desea cubrir el tejado con tejas de 30 cm de largo y 20 cm de ancho. ¿Cuántas tejas se necesitan?',
        respuestaNumerica: ['Número de tejas = 800'],
        unidadRespuesta: ['unidades'],
        pasos: [
          'Calcular el área total del tejado: 2 x (base x altura) / 2.',
      ...
      {
        ecuacion: 'Una puerta trapezoidal tiene una altura de 2 metros, una base mayor de 1 metro y una base menor de 0.8 metros. Se desea pintar la superficie de la puerta. ¿Cuántos metros cuadrados de pintura se necesitan?',
        respuestaNumerica: ['Área total = 1.9 metros cuadrados'],
        unidadRespuesta: ['m^2'],
        pasos: [
      ...
      {
        ecuacion: 'Un estanque circular tiene un radio de 5 metros. Se desea cubrir el fondo del estanque con grava. ¿Cuántos metros cuadrados de grava se necesitan?',
      ...
      {
        ecuacion: 'Un tanque rectangular tiene una longitud de 2 metros, una anchura de 1 metro y una altura de 1.5 metros. Se desea calcular el volumen del tanque.',
        respuestaNumerica: ['Volumen = 3 metros cúbicos'],
        unidadRespuesta: ['m^3'],
        pasos: [
          'Calcular el volumen del tanque: largo x ancho x altura.'
        ]
      },
      {
        ecuacion: 'Una fosa séptica circular tiene un radio de 1 metro y una profundidad de 1.5 metros. Se desea calcular el volumen de la fosa séptica.',
      ...
      {
        ecuacion: 'Un pozo de agua rectangular tiene una longitud de 3 metros, una anchura de 2 metros y una profundidad de 10 metros. Se desea calcular el volumen del pozo de agua.',
        respuestaNumerica: ['Volumen = 60 metros cúbicos'],
        unidadRespuesta: ['m^3'],
        pasos: [
      ...
      {
        ecuacion: 'Una cúpula semiesférica tiene un radio de 5 metros. Se desea calcular el volumen de la cúpula.',
        respuestaNumerica: ['Volumen = 523.6 metros cúbicos'],
        unidadRespuesta: ['m^3'],
        pasos: [
          'Calcular el volumen de la cúpula: (2/3)πr^3.'
        ]
      },
      {
      ...
      {
        ecuacion: 'Una ventana circular tiene un radio de 0.5 metros. Se desea instalar una reja de metal alrededor de la ventana. ¿Cuántos metros de metal se necesitan para la reja?',
        respuestaNumerica: ['Longitud reja = 3.14 metros'],
        unidadRespuesta: ['m'],
        pasos: [
      ...
      {
        ecuacion: 'Una baldosa mide 20 centímetros de largo y 10 centímetros de ancho. ¿Cuántos centímetros cuadrados mide?',
      ...
      {
        ecuacion: 'Un tanque de gasolina tiene un volumen de 50 litros. ¿Cuántos metros cúbicos de gasolina tiene?',
      ...
      {
        ecuacion: 'Un avión vuela a una altitud de 10000 metros. ¿A cuántos kilómetros de altura vuela?',
        respuestaNumerica: ['Altura = 10 kilómetros'],
        unidadRespuesta: ['km'],
        pasos: [
          'Para convertir de metros a kilómetros, divide por 1000.',
          'Altura en km = 10000 metros / 1000 = 10 kilómetros.'
        ]
      },
      {
      ...
      {
        ecuacion: 'Un tanque de gasolina tiene un volumen de 20 litros. ¿Cuántos metros cúbicos de gasolina tiene?',
      ...
      {
        ecuacion: 'Una mesa tiene una superficie de 48 pulgadas cuadradas. ¿Cuántos centímetros cuadrados mide?',
      ...
      {
        ecuacion: 'Un viaje en barco tiene una distancia de 5000 millas. ¿Cuántos kilómetros son?',
      ...
      {
        ecuacion: 'Un viaje en barco de crucero tiene una distancia de 5000 millas. ¿Cuántos kilómetros son?',
        respuestaNumerica: ['Distancia = 8046.7 kilómetros'],
        unidadRespuesta: ['km'],
        pasos: [
          'Para convertir de millas a kilómetros, multiplica por 1.60934.',
...
const problemasMatematicos = [
    {
        ecuacion: '5x^2 - 3x + 2 = 0',
        respuestaNumerica: ['x = -0.2', 'y = 1'],
        unidadRespuesta: ['mm'],
        pasos: [
            'Calcular el discriminante: Δ = b^2 - 4ac',
            'Usar la fórmula cuadrática: x = (-b ± √Δ) / (2a)',
            'Simplificar y obtener las soluciones.'
        ]
    },
    {
        ecuacion: '2y^2 + 4y - 6 = 0',
        respuestaNumerica: ['x = 1', 'y = -3'],
        unidadRespuesta: ['mm'],
        pasos: [
            'Calcular el discriminante: Δ = b^2 - 4ac',
            'Usar la fórmula cuadrática: y = (-b ± √Δ) / (2a)',
            'Simplificar y obtener las soluciones.'
        ]
    },
    {
...
*/
//console.log(problemasMatematicos);
//console.log("Cantidad de ejercicios:",problemasMatematicos.length);
...
function mostrarProblemaAleatorio() {
    ...
    respuestaOficial.innerHTML = `${problemaAleatorio.respuestaNumerica}`;
...
function revisarResultado() {
    ...
    let resultadoUsuario = respuesta.value.trim();
        unidadUsuario = document.getElementById("unidad").value.trim();
    ...
    try {
        ...
        //console.log(respuestasCorrectasAproximadas);
        ...
        //console.log("Unidad ingresada por usuario:",unidadUsuario);
        ...
        //console.log(sonRespuestasCorrectas);
